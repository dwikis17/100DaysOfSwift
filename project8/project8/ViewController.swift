...
class ViewController: UIViewController {
    ...
    override func loadView() {
        ...
        answerLabel = setupAnswerLabel()
        cluesLabel = setupCluesLabel()
        currentAnswer = setupCurrentAnswerLabel()
        ...
        NSLayoutConstraint.activate([
            ...
            buttonsView.topAnchor.constraint(equalTo: submit.bottomAnchor, constant: 30),
        ...
        for row in 0..<4 {
            for column in 0..<5 {
                ...
                letterButton.addTarget(self, action: #selector(letterTapepd), for: .touchUpInside)
                letterButton.layer.borderWidth = 1
                letterButton.layer.borderColor = UIColor(red:222/255, green:225/255, blue:227/255, alpha: 1).cgColor
    ...
    @objc func letterTapepd(_ sender: UIButton) {
    ...
    func isAllButtonsAreHidden() -> Bool {
        var isHidden = true
    ...
    @objc func submitTapped(_ sender:UIButton){
        ...
        if let solutionPosition = solutions.firstIndex(of: answerText) {
            ...
            let ac = UIAlertController(title: "Wrong", message: "answer not found ! 1 point deducted", preferredStyle: .alert)
    ...
    func setupCurrentAnswerLabel() -> UITextField {
